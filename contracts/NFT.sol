...
// Based on OpenZeppelin contract but this have to be initialize before deployed
...
contract NFT is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _transfer(
        ...
        require(NFT.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
