...
describe("Unit tests", function () {
  ...
  describe("Revenue Factory", function () {
    beforeEach(async function () {
      ...
      let cloneTx  = await this.stakedShareFactory.connect(this.signers.admin).stakedShare(implementation, projectToken, name, symbol, logo, {value: shareFee});
      let clonedTx = await cloneTx.wait();
